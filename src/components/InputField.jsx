    ...
    <>
      <div className="pt-4">
        ...
        <div className="input bg-[#434141] rounded-xl p-1 mt-3 flex">
		  ...
		  <input value={data.useStateVariable} onChange={(event)=>data.useStateFunction(event.target.value)} className="text-white w-full outline-none" type={data.type} placeholder={data.placeholder} />
        </div>
      </div>
    </>
  );
